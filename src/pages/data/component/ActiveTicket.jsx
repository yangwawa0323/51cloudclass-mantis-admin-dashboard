...
class ActiveTicket extends React.Component {
    generateRandomTableBodyContent() {
        return Array.from(Array(4).keys()).map((_, index) => (
            <TableRow key={index}>
                ...
                <TableCell>
                    <Grid container spacing={2} alignItems={{ xs: 'center' }} justifyContent={{ xs: 'center', md: 'unset' }}>
                        <Grid item>
                ...
                >
                    <TableContainer>
                        <Table aria-label="simple table">
                            ...
                            <TableBody>{this.generateRandomTableBodyContent()}</TableBody>
                        </Table>
                    </TableContainer>
                </CardContent>
            </Card>
