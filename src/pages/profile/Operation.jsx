...
const EditBtnGroup = (props) => {
    ...
    const [openEditUserProfile, setOpenEditUserProfile] = useState(false);
    ...
    return (
        <div>
            <div className="op-btn-group">
                ...
                <button className="edit" onClick={editUserProfile} tabIndex="0" type="button" aria-label="Edit">
            ...
            <div>{openEditUserProfile && <EditUserProfile node={node} open={openEditUserProfile}></EditUserProfile>}</div>
        </div>
    );
};

EditBtnGroup.propTypes = {
